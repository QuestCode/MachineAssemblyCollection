...
_start:
	...
	writestring crlf, lencrlf
						;eax holds base address
						;ecx is index register
getNextElement:
						;copy value from asciinums into an 8-bit register
						;compare the 8-bit register to target value
						;jump if equal to the found label
						;increment index register
						;compare index register to decimal 10
						;if index register not equal to 10 go to getNextElement
